              ...
              <tbody class="table-border-bottom-0">
                @foreach ($attrs as $item)
                  <tr>
                    ...
                    <td><span class="badge bg-label-primary me-1">{{ $item->type }}</span></td>
                    <td><span class="badge bg-label-danger me-1">{{ $item->value }}</span></td>
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                          <a class="dropdown-item" href="/admin/edit/{{$item->id}}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
