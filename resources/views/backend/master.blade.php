        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text logo demo menu-text fw-bolder ms-2" style="text-transform: uppercase;">KH-SHOP</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            {{-- <li class="menu-item">
              <a href="/admin/log-activity" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-bolt-circle"></i>
                <div data-i18n="Layouts">Log Activity</div>
              </a> --}}
